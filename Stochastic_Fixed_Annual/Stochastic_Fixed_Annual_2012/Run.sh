#!/bin/bash
#SBATCH --job-name=9_Rep_VRE_Scenarios_Annual       # create a short name for your job
...
#SBATCH --output="./9_Rep_VRE_Scenarios_CRM/9_Rep_VRE_Scenarios_Annual/%j.out"
#SBATCH --error="./9_Rep_VRE_Scenarios_CRM/9_Rep_VRE_Scenarios_Annual/%j.err"
...
julia --project=. ./9_Rep_VRE_Scenarios_CRM/9_Rep_VRE_Scenarios_Annual/Run.jl
